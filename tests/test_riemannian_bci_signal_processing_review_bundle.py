"""Review bundle structure tests for riemannian_bci signal_processing."""
...
def test_riemannian_bci_signal_processing_review_bundle_structure() -> None:
    bundle = _load_bundle(BUNDLE_DIR / "riemannian_bci_signal_processing.review_bundle.json")
...
def test_riemannian_bci_signal_processing_review_bundle_covers_expected_rows() -> None:
    bundle = _load_bundle(BUNDLE_DIR / "riemannian_bci_signal_processing.review_bundle.json")
    assert {row["atom_key"] for row in bundle["rows"]} == {
        "sciona.atoms.riemannian_bci.signal_processing.segment_max_aggregation",
        "sciona.atoms.riemannian_bci.signal_processing.ranked_prediction_blend",
    }
