"""Review bundle structure tests for riemannian_bci covariance_features."""
...
def test_riemannian_bci_covariance_features_review_bundle_structure() -> None:
    bundle = _load_bundle(BUNDLE_DIR / "riemannian_bci_covariance_features.review_bundle.json")
...
def test_riemannian_bci_covariance_features_review_bundle_covers_expected_rows() -> None:
    bundle = _load_bundle(BUNDLE_DIR / "riemannian_bci_covariance_features.review_bundle.json")
    assert {row["atom_key"] for row in bundle["rows"]} == {
        "sciona.atoms.riemannian_bci.covariance_features.autocorrelation_covariance_matrix",
        "sciona.atoms.riemannian_bci.covariance_features.cross_frequency_coherence_matrix",
        "sciona.atoms.riemannian_bci.covariance_features.tangent_space_projection",
        "sciona.atoms.riemannian_bci.covariance_features.riemannian_mean_spd",
    }
